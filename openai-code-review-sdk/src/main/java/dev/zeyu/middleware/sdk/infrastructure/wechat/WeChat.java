package dev.zeyu.middleware.sdk.infrastructure.wechat;

import com.alibaba.fastjson2.JSON;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import dev.zeyu.middleware.sdk.infrastructure.wechat.dto.TemplateMessageDTO;
import dev.zeyu.middleware.sdk.types.utils.WeChatAccessTokenUtils;
...
public class WeChat {
    ...
    public void sendTemplateMessage(String logUrl, Map<String, Map<String, String>> data) throws Exception {
        ...
        try (Scanner scanner = new Scanner(conn.getInputStream(), StandardCharsets.UTF_8.name())) {
            ...
            logger.info("openai-code-review wechat template message! {}", response);
        }
    }
}
